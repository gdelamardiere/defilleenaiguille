        ...
        <div class="carousel-inner">
            ...
            foreach ($listeImage as $image) {
                ...
                <div class="item<?php echo $active; ?>">
                    <?php
                    echo '<li><a href="' . FRONT_IMAGE . $image . '" rel="lightbox"><img data-src="holder.js/900x500/auto/#777:#555/text:First slide" src="' . FRONT_IMAGE_MEDIUM . $image . '" alt="' . $image . '" /></a></li>';
                    ?>
