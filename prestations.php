                ...
                <ul class="polaroids large-block-grid-4 small-block-grid-2">
                    <li>
                        <a title="les fauteuils" href="<?php echo SITE_FRONT; ?>fauteuils.php">
                            <img src="<?php echo divers::getOneRandomImageFromRep("fauteuils/"); ?>" alt="fauteuil">
                        </a>
                    </li>
                    <li>
                        <a title="la teinture murale" href="<?php echo SITE_FRONT; ?>murs-et-fenetres.php">
                            <img src="<?php echo divers::getOneRandomImageFromRep("coussins/"); ?>" alt="la teinture murale">
                        </a>
                    </li>
                    <li>
                        <a title="les rideaux" href="<?php echo SITE_FRONT; ?>fauteuils.php">
                            <img src="<?php echo divers::getOneRandomImageFromRep("rideau/"); ?>" alt="les rideaux">
                        </a>
                    </li>
                    <li>
                        <a title="le lit" href="<?php echo SITE_FRONT; ?>fauteuils.php">
                            <img src="<?php echo divers::getOneRandomImageFromRep("lit/"); ?>" alt="le lit">
                        </a>
                    </li>
                    <li>
                        <a title="les coussins" href="<?php echo SITE_FRONT; ?>fauteuils.php">
                            <img src="<?php echo divers::getOneRandomImageFromRep("coussins/"); ?>" alt="les coussins">
                        </a>
                    </li>
                </ul>
            </div>
